...
enum CosCharacterSet {
    ...
    CosCharacterSet_LatinCapitalLetterG = 0x47,
    CosCharacterSet_LatinCapitalLetterH = 0x48,
    CosCharacterSet_LatinCapitalLetterI = 0x49,
    CosCharacterSet_LatinCapitalLetterJ = 0x4A,
    CosCharacterSet_LatinCapitalLetterK = 0x4B,
    CosCharacterSet_LatinCapitalLetterL = 0x4C,
    CosCharacterSet_LatinCapitalLetterM = 0x4D,
    CosCharacterSet_LatinCapitalLetterN = 0x4E,
    CosCharacterSet_LatinCapitalLetterO = 0x4F,
    CosCharacterSet_LatinCapitalLetterP = 0x50,
    CosCharacterSet_LatinCapitalLetterQ = 0x51,
    CosCharacterSet_LatinCapitalLetterR = 0x52,
    CosCharacterSet_LatinCapitalLetterS = 0x53,
    CosCharacterSet_LatinCapitalLetterT = 0x54,
    CosCharacterSet_LatinCapitalLetterU = 0x55,
    CosCharacterSet_LatinCapitalLetterV = 0x56,
    CosCharacterSet_LatinCapitalLetterW = 0x57,
    CosCharacterSet_LatinCapitalLetterX = 0x58,
    CosCharacterSet_LatinCapitalLetterY = 0x59,
    CosCharacterSet_LatinCapitalLetterZ = 0x5A,
    ...
    CosCharacterSet_LatinSmallLetterG = 0x67,
    CosCharacterSet_LatinSmallLetterH = 0x68,
    CosCharacterSet_LatinSmallLetterI = 0x69,
    CosCharacterSet_LatinSmallLetterJ = 0x6A,
    CosCharacterSet_LatinSmallLetterK = 0x6B,
    CosCharacterSet_LatinSmallLetterL = 0x6C,
    CosCharacterSet_LatinSmallLetterM = 0x6D,
    CosCharacterSet_LatinSmallLetterN = 0x6E,
    CosCharacterSet_LatinSmallLetterO = 0x6F,
    CosCharacterSet_LatinSmallLetterP = 0x70,
    CosCharacterSet_LatinSmallLetterQ = 0x71,
    CosCharacterSet_LatinSmallLetterR = 0x72,
    CosCharacterSet_LatinSmallLetterS = 0x73,
    CosCharacterSet_LatinSmallLetterT = 0x74,
    CosCharacterSet_LatinSmallLetterU = 0x75,
    CosCharacterSet_LatinSmallLetterV = 0x76,
    CosCharacterSet_LatinSmallLetterW = 0x77,
    CosCharacterSet_LatinSmallLetterX = 0x78,
    CosCharacterSet_LatinSmallLetterY = 0x79,
    CosCharacterSet_LatinSmallLetterZ = 0x7A,
